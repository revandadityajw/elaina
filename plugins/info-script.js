    ...
    message: {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          body: proto.Message.InteractiveMessage.Body.create({
            text: "PENCET TOMBOL DI BAWAH INI UNTUK MENUJU SALURAN"
          }),
          footer: proto.Message.InteractiveMessage.Footer.create({
            text: "SCRIPT"
          }),
          header: proto.Message.InteractiveMessage.Header.create({
            title: "NYARI SCRIPT?\nSCRIPT ADA DI SALURAN",
            subtitle: "SCRIPT",
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [            
                                          {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"SALURANNYA\",\"url\":\"https://whatsapp.com/channel/0029VaF8RYn9WtC16ecZws0H\",\"merchant_url\":\"https://whatsapp.com/channel/0029VaF8RYn9WtC16ecZws0H\"}"
              }
           ],
          })
        })
